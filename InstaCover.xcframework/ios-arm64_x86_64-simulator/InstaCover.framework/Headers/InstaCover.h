...
@class InstaCoverHelpersCompanion, UIView, NSObject, InstaCoverLogPayload;
...
- (void)logToBackendSessionId:(NSString *)sessionId message:(NSString *)message __attribute__((swift_name("logToBackend(sessionId:message:)")));
@end;
